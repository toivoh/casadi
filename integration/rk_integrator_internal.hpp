...
public:
  ...
  /// Constructor
  explicit RKIntegratorInternal(const FX& f, int nfwd, int nadj);
  ...
  virtual RKIntegratorInternal* create(const FX& f, int nfwd, int nadj) const{ return new RKIntegratorInternal(f,nfwd,nadj);}
