...
namespace CasADi{
  ...
  */
  ...
  public:
     ...
     */
    explicit CollocationIntegrator(const FX& dae, int nfwd=0, int nadj=0);
    ...
    %callback("%s_cb");
#endif
    static Integrator creator(const FX& dae, int nfwd, int nadj){ return CollocationIntegrator(dae,nfwd,nadj);}
#ifdef SWIG
    %nocallback;
#endif
